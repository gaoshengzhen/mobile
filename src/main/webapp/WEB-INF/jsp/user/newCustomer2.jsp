...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  ...
  <TR vAlign=top>
    ...
    <form method="POST" action="user_newUser">
      <p>证件类型：<input type="text" name="id_type" size="20" value=${m.id_type } readonly="readonly"></p>
      <p>证件号码：<input type="text" name="id_number" size="20" value=${m.id_number } readonly="readonly"></p>
      <p>姓名：<input type="text" name="customer_name" size="20" value=${m.customer_name }></p>
      <p>性别：<input type="radio" value="男" checked name="customer_sex">男&nbsp;&nbsp; <input type="radio" name="customer_sex" value="女">女</p>
      <p>生日：<input type="text" name="customer_birthday" size="20" value=${m.customer_birthday }></p>
      <p>联系地址：<input type="text" name="customer_address" size="20" value=${m.customer_address }></p>
      <p>　</p>
