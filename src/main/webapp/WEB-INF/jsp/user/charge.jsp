...
$(function(){
	$("#cha").change(function(){
    $.post("url",{D1:$(this).val()},function(data){
 			$('#c').val(data)
     })
   })
   $("#cha").change()
...
<h2>收费细项</h2>
    <form method="POST" action="charge">
      <p>收费项目：<select size="1" name="D1" id="cha">
      ...
      <p>收费金额：<input type="text" name="T1" size="20" id="c"></p>
